...
9.  **Status Effects**: Tag-based input system.
    *   Supports durations ("1 round", "Until next turn").
    *   Auto-expires statuses based on turn progression.
    *   Preserves "future" statuses if the user rewinds the turn, but visually dims them.
